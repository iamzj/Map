...
public class Visible implements Serializable{
    ...
    private static final long serialVersionUID = 3490746190718463080L;
    ...
    public static int getVisibleNormal() {
        return VISIBLE_NORMAL;
    }

    public static int getVisiblePrivacy() {
        return VISIBLE_PRIVACY;
    }

    public static int getVisibleGrouped() {
        return VISIBLE_GROUPED;
    }

    public static int getVisibleFriend() {
        return VISIBLE_FRIEND;
    }
